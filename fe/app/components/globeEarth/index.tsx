...
export function GlobeEarth() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-2 dark:bg-black bg-white relative w-full">
      <div className="max-w-3xl mx-auto w-full relative overflow-hidden px-2">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
